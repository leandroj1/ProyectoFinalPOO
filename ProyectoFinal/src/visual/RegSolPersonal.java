		...
		contentPanel.setLayout(new BorderLayout(0, 0));
		{
			...
			panel.setLayout(null);
			{
				...
				txtFRNC.setForeground(Color.BLACK);
				{
					...
					label3.setBounds(35, 309, 269, 14);
					panel_1.add(label3);

					JLabel label2 = new JLabel("\u00BFPosee disponibilidad para cambiar de residencia?");
					label2.setBounds(35, 339, 269, 14);
					panel_1.add(label2);

					JRadioButton rbSDispSalirCiudad = new JRadioButton("S\u00ED");
					rbSDispSalirCiudad.setBounds(367, 306, 56, 23);
					panel_1.add(rbSDispSalirCiudad);

					JRadioButton rbSDispCambiarRes = new JRadioButton("S\u00ED");
					rbSDispCambiarRes.setBounds(367, 336, 56, 23);
					panel_1.add(rbSDispCambiarRes);

					JRadioButton rbNDispSalirCiudad = new JRadioButton("No");
					rbNDispSalirCiudad.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent e) {
							if(rbNDispSalirCiudad.isSelected()) {
								rbSDispSalirCiudad.setSelected(false);
							}
						}
					});
					rbNDispSalirCiudad.setBounds(445, 306, 48, 23);
					panel_1.add(rbNDispSalirCiudad);

					JRadioButton rbNDispCambiarRes = new JRadioButton("No");
					rbNDispCambiarRes.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent e) {
							if(rbNDispCambiarRes.isSelected()) {
								rbSDispCambiarRes.setSelected(false);
							}
						}
					});

					rbSDispCambiarRes.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent e) {
							if(rbSDispCambiarRes.isSelected()) {
								rbNDispCambiarRes.setSelected(false);
							}
						}
					});
					rbNDispCambiarRes.setBounds(445, 336, 48, 23);
					panel_1.add(rbNDispCambiarRes);


					rbSDispSalirCiudad.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent e) {
							if(rbSDispSalirCiudad.isSelected()) {
								rbNDispSalirCiudad.setSelected(false);
							}
						}
					});
